...
data TranslationContext (t :: OSL.ContextType) ann = TranslationContext
...
newtype LeftMapping ann a = LeftMapping {unLeftMapping :: Mapping ann a}
  deriving (Show)

newtype RightMapping ann a = RightMapping {unRightMapping :: Mapping ann a}
  deriving (Show)

newtype ChoiceMapping ann a = ChoiceMapping {unChoiceMapping :: Mapping ann a}
  deriving (Show)

newtype LengthMapping ann a = LengthMapping {unLengthMapping :: Mapping ann a}
  deriving (Show)

newtype ValuesMapping ann a = ValuesMapping {unValuesMapping :: Mapping ann a}
  deriving (Show)

newtype KeysMapping ann a = KeysMapping {unKeysMapping :: Mapping ann a}
  deriving (Show)
